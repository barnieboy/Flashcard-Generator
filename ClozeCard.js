...
// Constructor that creates a prototype of ClozeCard to give us the question missing cloze
function ClozeCardPrototype(){
	
	this.clozeRemoved = function(){
		return `${this.text[0]} ... ${this.text[1]}`; // Allows embedded expressions wrapped with ${}
